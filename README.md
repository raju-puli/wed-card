...
Any change pushed to the repo will also be reflected in the Wedding Builder.
...
```
VITE_WEDDING_APP_ID=your_app_id
VITE_WEDDING_APP_BASE_URL=your_backend_url

e.g.
VITE_WEDDING_APP_ID=cbef744a8545c389ef439ea6
VITE_WEDDING_APP_BASE_URL=https://my-to-do-list-81bfaad7.db.app
```
